...
@section('title', 'Modifier le Projet - Administration')
...
<div class="mb-8">
    <div class="flex items-center gap-4 mb-4">
        ...
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Modifier le Projet</h1>
    </div>
    <p class="text-gray-600 dark:text-gray-300">Modifiez les informations du projet</p>
</div>

<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8">
    <form action="{{ route('admin.projects.update', $project->id) }}" method="POST" id="project-form" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="4" required
                              class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">{{ old('description', $project->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <select id="type" name="type" required onchange="toggleProjectFields()"
                        ...
                        <option value="web" {{ old('type', $project->type) == 'web' ? 'selected' : '' }}>Site Web</option>
                        <option value="mobile" {{ old('type', $project->type) == 'mobile' ? 'selected' : '' }}>Application Mobile</option>
                        <option value="desktop" {{ old('type', $project->type) == 'desktop' ? 'selected' : '' }}>Application Desktop</option>
                    </select>
                    @error('type')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" id="year" name="year" value="{{ old('year', $project->year) }}" required maxlength="4" pattern="\d{4}"
                           class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                    @error('year')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select id="color" name="color" required
                        ...
                        <option value="emerald" {{ old('color', $project->color) == 'emerald' ? 'selected' : '' }}>Émeraude</option>
                        ...
                        <option value="rose" {{ old('color', $project->color) == 'rose' ? 'selected' : '' }}>Rose</option>
                    </select>
                    @error('color')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" id="company" name="company" value="{{ old('company', $project->company) }}" required
                           class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                    @error('company')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
        ...
        <div id="web-fields" class="mb-8 {{ $project->type !== 'web' ? 'hidden' : '' }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="url" id="logo_url" name="logo_url" value="{{ old('logo_url', $project->logo_url) }}"
                           class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="url" id="site_url" name="site_url" value="{{ old('site_url', $project->site_url) }}"
                           class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="url" id="main_image_web" name="main_image" value="{{ old('main_image', $project->type === 'web' ? $project->main_image : '') }}"
                           class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
        ...
        <div id="mobile-fields" class="mb-8 {{ $project->type !== 'mobile' ? 'hidden' : '' }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="url" id="logo_url_mobile" name="logo_url" value="{{ old('logo_url', $project->logo_url) }}"
                           class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                           placeholder="https://example.com/logo.png">
                </div>
                ...
                <div>
                    ...
                    <input type="url" id="main_image_mobile" name="main_image" value="{{ old('main_image', $project->type === 'mobile' ? $project->main_image : '') }}"
                           class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                           placeholder="https://example.com/screenshot.png">
                </div>
                ...
                <div>
                    ...
                    <input type="url" id="ios_url" name="ios_url" value="{{ old('ios_url', $project->ios_url) }}"
                           class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="url" id="android_url" name="android_url" value="{{ old('android_url', $project->android_url) }}"
                           class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
        ...
        <div id="desktop-fields" class="mb-8 {{ $project->type !== 'desktop' ? 'hidden' : '' }}">
            ...
            <div class="mb-6">
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Images actuelles (remplacer par de nouvelles images si nécessaire)</p>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    @foreach($project->screenshots as $index => $screenshot)
                    <div class="relative group">
                        <img src="{{ asset('storage/' . $screenshot) }}" alt="Capture {{ $index + 1 }}" class="w-full h-32 object-cover rounded-lg border border-gray-200 dark:border-gray-600">
            ...
            <div class="mb-4">
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Ajouter de nouvelles images (remplacera les images actuelles)</p>
            </div>
